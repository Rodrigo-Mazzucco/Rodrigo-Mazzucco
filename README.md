...
<p align="center">
  <a href="https://www.linkedin.com/in/rodrigo-marchione-mazzucco" target="_blank">
...
Meu foco principal de atuação e estudo envolve:
- **Engenharia de Dados:** Modelagem relacional, normalização avançada e queries SQL.
- **Desenvolvimento Backend:** Construção de APIs, automação de processos e estruturação de sistemas.
...
*(+ Experiência acadêmica com C, PHP e JavaScript)*
...
**DevOps & Ferramentas:** ![Git](https://img.shields.io/badge/Git-F05032?style=for-the-badge&logo=git&logoColor=white)
